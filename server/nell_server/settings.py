...
DATABASE_ENGINE = 'postgresql' #'mysql'           # 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
DATABASE_NAME = 'dss_pmargani'             # Or path to database file if using sqlite3.
