######################################################################
#
#  Maintenance_Software_Resources.py - defines the model classes for
...
class Maintenance_Software_Resources(models.Model):
    ...
    class Meta:
        db_table = "maintenance_software_resources"
        app_label = "users"
