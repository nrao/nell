...
class ColumnDefinition {
    ...
    private final ColumnType[] columns = new ColumnType[] {
            new ColumnType(NAME,           "Name",           190, String.class,               null),
            new ColumnType(CODE,           "Proj Code",       60, String.class,               null),
            new ColumnType(ORIG_ID,        "Orig ID",         42, Integer.class,              null),
            new ColumnType(ID,             "ID",              42, Integer.class,              null),
            new ColumnType(TYPE,           "Type",            48, STypeField.class,           null),
            ...
            new ColumnType(GRADE,          "Grade",           40, GradeField.class,           null),
            new ColumnType(AUTHORIZED,     "Authorized",      60, Boolean.class,              null),
            new ColumnType(ENABLED,        "Enabled",         60, Boolean.class,              null),
            new ColumnType(COMPLETE,       "Complete",        60, Boolean.class,              null),
            new ColumnType(COORD_MODE,     "Coord Mode",      67, CoordModeField.class,       null),
            ...
            new ColumnType(REQ_MIN,        "Req Min",         50, Double.class,               null),
            new ColumnType(REQ_MAX,        "Req Max",         50, Double.class,               null),
            new ColumnType(ABS_MIN,        "Abs Min",         50, Double.class,               null),
            new ColumnType(ABS_MAX,        "Abs Max",         50, Double.class,               null),
            new ColumnType(BETWEEN,        "Between",         50, Double.class,               null),
            new ColumnType(OBS_EFF_LIMIT,  "Obs Eff Limit",   90, Double.class,               obsEffLimit),
            new ColumnType(ATMOS_ST_LIMIT, "Atmos St Limit",  90, Double.class,               atmosStLimit),
            new ColumnType(TR_ERR_LIMIT,   "Tr Err Limit",    90, Double.class,               trErrLimit),
            new ColumnType(MIN_EFF_TSYS,   "Min Eff TSys",    90, Double.class,               minEffTsys),
            new ColumnType(HA_LIMIT,       "HA Limit",        90, Double.class,               haLimit),
            new ColumnType(ZA_LIMIT,       "ZA Limit",        90, Double.class,               null),
            new ColumnType(SOLAR_AVOID,    "Solar Avoid",     90, Boolean.class,              null),
            new ColumnType(PRECIP,         "Precip",          90, Double.class,               null),
            new ColumnType(WIND,           "Wind",            90, Double.class,               null),
            new ColumnType(TIME_DAY,       "Time Day",        50, TimeOfDayField.class,       null),
